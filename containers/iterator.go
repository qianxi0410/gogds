...
// IteratorWithKey is a stateful iterator for ordered containers
...
// ReverseIteratorWithIndex is stateful iterator for ordered containers
// whose values can be fetched by an index.
...
// ReverseIteratorWithKey is a stateful iterator for ordered containers
// whose elements are key value pairs.
